    ...
    <div>
      <section className=" min-h-screen flex items-center justify-center  bg-gray-800  text-gray-100">
        ...
        <div className=" flex rounded-2xl shadow-lg max-w-3xl p-5 items-center   bg-gray-900  text-gray-100">
          {/* form */}
          <div className="md:w-1/2 px-8 md:px-16  bg-gray-900  text-gray-100">
            <h2 className="font-bold text-2xl text-[#002D74]  text-slate-200">Login</h2>
            <p className="text-xs mt-4 text-[#002D74]  text-slate-200">
            ...
            <button onClick={handleGoogleSignIn} className="bg-white border p-3 rounded-full mt-5  hover:scale-105 duration-300 text-[#002D74]  bg-slate-300">
              <svg
                className=""
            ...
            <button onClick={handleGithubSignIn} className="bg-white border p-3 rounded-full mt-5  hover:scale-105 duration-300 text-[#002D74]  bg-slate-300">
...
{/* 
            ...
            <div className="mt-3 text-xs flex justify-between items-center text-[#002D74] ">
              ...
              <Link to='/register' className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300  bg-slate-300">
                Register
              </Link>
            </div>
          </div>
