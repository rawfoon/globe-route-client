...
const Subscribe = () => {
    return (
        <div className='container mx-auto'>
            <div className="w-full  bg-gray-500" style={{backgroundImage: "url('https://i.ibb.co/bWdKKXz/pexels-oleksandr-pidvalnyi-3278215-1.jpg')", backgroundPosition: 'center center', backgroundBlendMode: 'multiply', backgroundSize: 'cover'}}>
